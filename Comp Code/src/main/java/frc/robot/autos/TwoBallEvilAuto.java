...
public class TwoBallEvilAuto extends SequentialCommandGroup {

    private String trajectoryJSON1 = "paths/2BallKnockLeg1.wpilib.json";
    private Trajectory testTrajectory1 = new Trajectory();
    private String trajectoryJSON2 = "paths/2BallKnockLeg2.wpilib.json";
    private Trajectory testTrajectory2 = new Trajectory();


    public TwoBallEvilAuto(Swerve s_Swerve, IntakeIndex intakeIndex, Shooter shooter) {
